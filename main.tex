...
\begin{frame}{Assumptions}
  \begin{itemize}
  \item The system is stable (or has been stabilized by some inner-loop controller).
...
\begin{frame}{Detecting Replay Attacks}
  ...
  \item In the absence of the attack:  
    \begin{align*} 
      y_{k} &=\textcolor{red}{\boxed{\sum_{t=0}^{k-1} CA^{t}B  \phi_{k-1-t}}} + \textcolor{blue}{\boxed{\sum_{t=0}^{k-1}  CA^{t} w_{k-1-t}+v_{k} + CA^k x_0\nonumber}}\\ 
...
\begin{frame}{Optimal Watermark}
  ...
  \centering
  \begin{tikzpicture}
    \draw[thick,thupurple!50] (0,0)--(15:4);
    \draw[thick,thupurple!50] (0,0)--(60:4);
    \draw[thick,thupurple!50] (70:3)--(5:3);
    \fill[thupurple!20] (0,0)--(15:3)--(60:3)--(0,0);
  \end{tikzpicture}
