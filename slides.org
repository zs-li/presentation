...
** Definition of Cyber-Physical System
  {{{revealimg("./cps.meta","","35vh",nil,'none)}}}
...
** Applications
   {{{revealgrid(6, "./cps.grid", 60, 2, 2, "\"ga1 ga2\" \"ga1 ga3\"")}}}
   
*** Cyber-Physical-Human Energy System
   Complex interaction between humans, HVAC and grid. cite:Guan2010, cite:Jia2018
   {{{revealgrid(5, "./cpes.grid", 40, 2, 1, "\"ga1 ga2\"")}}}
  
** Convergence of Computation and Control 
    #+BEGIN_leftcol
    - Cyber Space
   {{{revealgrid(7, "./cyber.grid", 50, 1, 2, "\"ga1\" \"ga2\"")}}}
    #+END_leftcol
    #+BEGIN_rightcol
    - Physical Space
  {{{revealimg("./hvac.meta","","40vh",nil,'none)}}}
  \[\dot{x} = f(x)\]
    #+END_rightcol

#+REVEAL: split
- 1948: The term "Cybernetics" was coined by Norbert Wiener. {{{reveallicense("./wiener.meta","auto",nil,'none)}}}
...
#+REVEAL: split
- 2000: Panel on Future Directions in Control, Dynamics, and Systems cite:Murray2003 
...
** Many-Sidedness of CPS
    ...
    #+BEGIN_rightcol
    {{{revealimg("./acronis.meta","Simplified Diagram of Autonomous Car","40vh",nil,'none)}}}
    #+END_rightcol
...
/Networked control systems are spatially distributed systems in which the communication between sensors, actuators, and controllers occurs through a shared band-limited digital communication network./
  ...
  #+END_right
    {{{revealimg("./ncs.meta","Diagram of Networked Control System","40vh",nil,'none)}}}
...
- Problem proposed by Sinopoli et al. cite:Sinopoli2004
- System model:
\[x_{t+1} = A x_t + w_t,\,y_t = C x_t + v_t\]
- Erasure channel model:
\[\tilde y_t = \gamma_t y_t\]
  {{{revealimg("./estoverlossy.meta","","10vh",nil,'none)}}}
...
- Counterexample:
  ...
  {{{revealimg("./criticalvaluecounter.meta","","20vh",nil,'none)}}}
- Critical packet arrival probability is \(15/16\), not \(3/4\).
- The lower bound is tight if the system is non-degenerate, i.e., observability is preserved under different sampling frequency cite:Mo2012
- For degenerate system, the exact critical value is derived in cite:Sui2015

*** Control over Lossy Channels cite:Schenato2007
- System model:
\[x_{t+1} = A x_t + B \tilde u_t + w_t ,\,y_t = C x_t + v_t\]
- Channel model:
\[\tilde u_t = \nu_t u_t, \tilde y_t = \gamma_t y_t.\]
  {{{revealimg("./ctrloverlossy.meta","","20vh",nil,'none)}}}
...
- Optimal control policy (in the LQG sense): 
  - State follows a Gaussian mixture distribution cite:Lin2016
...
- The "optimal" schedule is periodic cite:Mo2014, cite:Zhao2014
- For special cases, closed form solution can be obtained. cite:Shi2011
- For general cases, convex relaxation cite:Mo2011 or submodularity cite:Shamaiah2010 can be exploited.
...
*** Deterministic Trigger 
   {{{revealgrid(3, "./det.grid", 20, 3, 1, "\"ga1 ga2 ga3\"")}}}
...
- Near optimal filter with low complexity can be used. cite:Wu2013, cite:Shi2014 

*** Stochastic Trigger
   {{{revealgrid(4, "./rand.grid", 20, 3, 1, "\"ga1 ga2 ga3\"")}}}
...
- The closed-form solution of the optimal filter is a Kalman like filter cite:Han2013
...
*** Threat Analysis and Design
    ...
    {{{reveallicense("./zero.meta","40vh",nil,'none)}}}
    #+END_leftcol
...
- Fundamental limit: The state can be "securely" estimated with bounded error only if the system is \(2p\)-detectable cite:Nakahira2018
 
*** Dynamic Estimator: Moving Horizon Approach
    {{{revealimg("./secureest1.meta","Moving Horizon with Window Size 3","40vh",nil,'none)}}}
cite:Fawzi2014, cite:Shoukry2017
...
*** Dynamic Estimator: Local Fusion Approach
    ...
    cite:Liu2017, cite:Mao2019
    
*** Dynamic Estimator: Switching Approach
    {{{revealimg("./secureest3.meta","Secure Estimator Design with Switching","40vh",nil,'none)}}}
    cite:Nakahira2018, cite:An2018
    
*** Case Study: Secure Est against GPS Spoofing for Vehicle Localization
    #+BEGIN_leftcol
    {{{revealimg("./gnssdrift.meta","EKF under GPS Spoofing","70vh",nil,'none)}}}
    #+END_leftcol
    #+BEGIN_rightcol
    {{{revealimg("./gnssdriftsafe.meta","Secure Filter under GPS Spoofing","70vh",nil,'none)}}}
    #+END_rightcol
...
- Additive noise mechanism for other distributed algorithms, e.g., estimation, optimization cite:Liu2019, cite:Wang2019, cite:He2020, cite:LeNy2014, cite:Cortes2016
...
- Partially Homomorphic Encryption:
  ...
  - One additively homomorphic encryption is [[https://en.wikipedia.org/wiki/Paillier_cryptosystem][Paillier cryptosystem]].
  - Given \(A\) and \(\mathcal E(x)\), one can compute \(\mathcal E(Ax)\), if additively homomorphic.
- Fully Homomorphic Encryption:  cite:Gentry2009
  - Both \(\oplus,\otimes\) exist
  - Computationally expensive
- Control algorithms based on homomorphic encryption: cite:Hadjicostis2019, cite:Shoukry2015, cite:Fang2018, cite:Yan2020
...
- Modular versus Cross-Layered Design {{{reveallicense("./cross.meta","40vh",nil,'none)}}}
- Model-based versus Data-driven?
  
** Towards a Science of Cyber-Physical System
- Much important work remains to be done: cite:Kumar
